...
# Delilah Hardware Accelerated Filtering

This repository contains the HLS-based filtering IP for Delilah, a Computational Storage Processor (CSP) built for the Daisy OpenSSD.
